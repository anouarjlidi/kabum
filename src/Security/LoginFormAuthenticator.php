...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    /**
     * The conditions for the authenticator to kick in.
     *
    ...
    {
        /*
         * When you attempt to access a page that requires you to be logged in,
         * it redirects you to the login form. The code below ensures that you
         * are redirected back to the page you were trying to access, after
